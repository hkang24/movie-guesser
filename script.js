...
window.addEventListener('load', (e) => {
    ...
    movieInfo = movies[randomNumber];

    const elem = document.createElement('div');
    description.innerHTML = '';

    elem.innerHTML = movieInfo.explanation;
...
submit.addEventListener('click', (e) => {
    ...
    if (input.value == movieInfo.title) {
        elem.classList.add('alert-success');
        elem.innerHTML = 'Yes, it was ' + movieInfo.title + '!';
      } else {
        elem.classList.add('alert-danger');
        elem.innerHTML = 'No, it was ' + movieInfo.title + ":(";
      }

    output.appendChild(elem);
});

hint_button.addEventListener('click', (e) => {
    const elem = document.createElement('div');
    hint.innerHTML = '';

    elem.innerHTML = 'Hint: ' + movieInfo.hint;
